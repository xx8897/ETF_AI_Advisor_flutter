...
class MyApp extends StatelessWidget {
  ...
  static final ThemeData vsCodeDarkTheme = ThemeData(
    ...
    scaffoldBackgroundColor: const Color(0xFF1E1E1E), // VS Code background
    colorScheme: const ColorScheme.dark(
      primary: Color(0xFF6A459A), // A deep purple for primary elements
      secondary: Color(0xFFCE9178), // An orange/tan for accents
      surface: Color(0xFF252526), // Slightly lighter surface color
      background: Color(0xFF1E1E1E),
      error: Colors.redAccent,
      onPrimary: Colors.white,
      onSecondary: Colors.white,
      onSurface: Color(0xFFD4D4D4), // VS Code text color
      onBackground: Color(0xFFD4D4D4),
      onError: Colors.black,
    ),
    appBarTheme: const AppBarTheme(
      backgroundColor: Color(0xFF333333), // VS Code activity bar
      elevation: 0,
    ),
